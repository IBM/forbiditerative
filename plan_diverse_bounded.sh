...
# $5 metric bound
# $6 total number of plans (optional, used k as default)
...
SCORE="subset_bounded("$(get_metric_param $4)"aggregator_metric=min,plans_as_multisets=true,plans_subset_size=$3,metric_bound=$5,metric_computation_method=mip,dump_plans=true)"
