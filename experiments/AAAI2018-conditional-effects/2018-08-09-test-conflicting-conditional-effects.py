...
def main(revisions=None):
    ...
    configs = {
        IssueConfig('rb-ce-conflicting', ['--heuristic', 'hrb=RB(dag=from_coloring, extract_plan=true, dump_conflicting_conditional_effects=true)', '--search', 'lazy_greedy([hrb],reopen_closed=false)'],
