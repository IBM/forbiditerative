...
def main(revisions=None):
    ...
    configs.add(IssueConfig('cerberus2018', [], build_options=BUILD_OPTIONS, driver_options=["--overall-time-limit", "30m", "--overall-memory-limit", "4096M", "--alias", "seq-agl-cerberus2018"]))
    configs.add(IssueConfig('cerberus2022', [], build_options=BUILD_OPTIONS, driver_options=["--overall-time-limit", "30m", "--overall-memory-limit", "4096M", "--alias", "seq-agl-cerberus-new"]))
    configs.add(IssueConfig('cerberus2022-novelops-argmax', [], build_options=BUILD_OPTIONS, driver_options=["--overall-time-limit", "30m", "--overall-memory-limit", "4096M", "--alias", "seq-agl-cerberus-novelops-argmax"]))
    configs.add(IssueConfig('cerberus2022-novelops-co1', [], build_options=BUILD_OPTIONS, driver_options=["--overall-time-limit", "30m", "--overall-memory-limit", "4096M", "--alias", "seq-agl-cerberus-novelops-co1"]))
