...
def main(revisions=None):
    ...
    configs.add(IssueConfig('cerberus', ["--evaluator",
        ...
        "--search", 'lazy(open=alt([tiebreaking([hn, hrb]), single(hn,pref_only=true), single(hlm)]), preferred=[hrb], cost_type=one,reopen_closed=false)'],
