...
export PYTHONPATH=$PWD && $SOURCE/forbiditerative/plan.py --planner submultisets_topq --domain $1 --problem $2 --quality-bound $3 $KBOUND --symmetries --use-local-folder --clean-local-folder --suppress-planners-output
