...
# $4 quality bound (b)
# $5 metric bound
# $6 metric (stability, state, uniqueness, stability-state, stability-uniqueness, state-uniqueness, stability-state-uniqueness, top-cost)
...
SCORE="subset_bounded("$(get_metric_param $6)"aggregator_metric=min,plans_as_multisets=true,plans_subset_size=$num_plans_to_find,metric_bound=$5,metric_computation_method=mip,dump_plans=true)"
